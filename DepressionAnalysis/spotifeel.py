...
def spotifeel(auth_manager, cache_handle):
    ...
    return [spotify.track(min_valence_id)['name'], spotify.track(min_valence_id)['id'], spotify.track(min_valence_id)['album']['images'][0]['url'], 
            spotify.track(max_valence_id)['name'], spotify.track(max_valence_id)['id'], spotify.track(max_valence_id)['album']['images'][0]['url'], 
